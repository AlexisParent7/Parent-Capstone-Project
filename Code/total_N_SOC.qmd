...
A linear regression was conducted to see if there was an effect between soil organic carbon (SOC) and total Nitrogen (total_N) concentration in the soil. From the results we can see there is an 
effect between total nitrogen and SOC concentration (p < 0.05, f = 212.6, df = 34).
