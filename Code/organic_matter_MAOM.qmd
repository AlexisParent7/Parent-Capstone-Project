...
From checking the assumptions we can see there are some interesting things going on with the normal distribution. The observations are grouped together, which is expected for the year, so I am going to continue. 
